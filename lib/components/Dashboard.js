...
Dashboard.propTypes = {
  ...
  /**
   * Will be called when a widget change by the user from the dashboard.
   * provides the updated layout object. This layout object with the new layout
